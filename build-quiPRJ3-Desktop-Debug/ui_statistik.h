...
public:
    ...
    void setupUi(QWidget *statistik)
    {
        ...
        NormalLabel->setGeometry(QRect(220, 50, 271, 16));
        ...
        WaterLabel->setGeometry(QRect(220, 140, 271, 16));
        StrongLabel = new QLabel(statistik);
        StrongLabel->setObjectName(QString::fromUtf8("StrongLabel"));
        StrongLabel->setGeometry(QRect(220, 110, 271, 16));
